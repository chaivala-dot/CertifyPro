...
export class Backend implements backendInterface {
    ...
    async createBatch(arg0: string, arg1: string, arg2: string, arg3: Array<Recipient>): Promise<void> {
    ...
    async createTemplate(arg0: string, arg1: string, arg2: string, arg3: Array<FieldDefinition>, arg4: ExternalBlob, arg5: ExternalBlob): Promise<void> {

        if (this.processError) {

            try {

                const result = await this.actor.createTemplate(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg5));
    ...
    async getBatch(arg0: string): Promise<CertificateBatch> {
    ...
    async getCertificate(arg0: string): Promise<Certificate> {
    ...
    async getTemplate(arg0: string): Promise<CertificateTemplate> {
        ...
        if (this.processError) {
            ...
            try {
                ...
                return from_candid_CertificateTemplate_n14(this._uploadFile, this._downloadFile, result);
    ...
    async getUserStats(): Promise<CertificateStats> {
    ...
    async listBatches(): Promise<Array<CertificateBatch>> {
    ...
    async updateTemplate(arg0: string, arg1: string, arg2: string, arg3: Array<FieldDefinition>, arg4: ExternalBlob, arg5: ExternalBlob): Promise<void> {

        if (this.processError) {

            try {

                const result = await this.actor.updateTemplate(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg5));
    ...
    async verifyCertificate(arg0: Uint8Array): Promise<Certificate> {
...
async function from_candid_CertificateTemplate_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CertificateTemplate): Promise<CertificateTemplate> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        logoImage: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.logoImage),
        ...
        backgroundImage: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.backgroundImage),
